...
<div class="index-app">
  ...
  <div class="head-page head-background">
      <h2 class="title main-title">Technology Mission Statement</h2>
      <p class="sub-title">The Internet of Services scales social and economic cooperation to a new level. We aim to gain universal acceptance and utilize decentralization and the power of blockchain technology to cut out middlemen and maximize network value for all parties.
<br><br>
      </p>  
        ...
        <div class="content">
          <div class="row title-row">
            <div class="col-lg-8">
                ...
                <li class="text-blue">Open</li>
                Anyone is able to participate in any layer of the system. No registration, identification or other preconditions should or will limit participation.
                <li class="text-blue">Immutable</li>
    ...
    <div class="content-page tech-items intelligent">
      <div class="middle-content">
        <div class="row title-row">
          <div class="col-lg-12">
            <h1 class="title">Intelligent Service System</h1>
          </div>
        </div>
                          <p>The IOS blockchain mitigates the tendency towards centralization by introducing Servi as both a measurement of individual users’ contribution to the community, and as a way to encourage members to contribute to the continued development of the IOS blockchain.
        <div class="list-group list-group-flush">

                  <li class="text-blue">Non-tradable </li>
                  Since Servi are not designed as a medium of exchange, Servi can not be traded or exchanged in any way.
                  <li class="text-blue">Self-terminating</li>
                  After validating a block, the system will automatically clear the Servi balance owned by the validator. In this way, nodes with high believability scores can take turns in validating blocks, to ensure a fair block generation process.
                  <li class="text-blue">Automated Issuance</li>
                  Servi will be generated and deposited to user accounts automatically after making contributions such as: providing community services, evaluating services provided by other entities, and/or making other special contributions.
              </p>                     
        </div>
      </div>
    </div>
    ...
    <div class="content-page tech-items tech-background">
      <div class="middle-content">
        <div class="row title-row">
          <div class="col-lg-12">
            <h1 class="title">Decentralized Governance</h1>
          </div>
        </div>
        <div class="list-group list-group-flush">
          ...
          <div class="list-group-item">
            <div class="item row">
              <div class="item-content col-lg-6">
                <h2 class="title">The Key to Blockchain Scalability</h2>
                <h4 class="text-blue">Available. Scalable. Safe</h4>
                <p class="desp">
          ...
          <div class="list-group-item">
            <div class="item row">
              <div class="item-content col-lg-6">
                <h2 class="title">Seamless Operability</h2>
                <h4 class="text-blue">Designed for security and reliability</h4>
                <p class="desp">
          ...
          <div class="list-group-item">
            <div class="item row">
              <div class="item-content col-lg-6">
                <h2 class="title">Space Saving</h2>
                <h4 class="text-blue">Performance improvements</h4>
                <p class="desp">
